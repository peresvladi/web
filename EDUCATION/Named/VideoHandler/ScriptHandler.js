...
//100725-закоментировал: case 88: if (true === confirm('Очистить LocalStorage ?')) {... (что-то срабатывает в коде и предлагает очистить localStorage - надо понаблюдать, может прекратится)
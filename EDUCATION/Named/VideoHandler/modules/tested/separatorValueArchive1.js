...
const valueSeparator = ()=> {
    ...
    CurrentKey = localStorage.getItem("1" + CurrentMenuItem).trim(); // из локального хранилища localStorage (Chrome) по ключу (ключ создается сложением "1" + CurrentMenuItem) из предыдущей строки получает строку подменю (точнее второй стандантный пункт подменю, типа: 0, 0, All..), и удаляет лишние пробелы 

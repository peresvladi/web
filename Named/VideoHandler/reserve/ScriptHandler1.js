...
function inputNow(e) {
    ...
    for (let x = 0; x < e.length; x++) {
        ...
        if (ifKeyLocStorage !== namePartVCatalog) {
            ...
            window.localStorage.setItem(y + namePartVCatalog, arrBodyLocStorage);
...
function go_key(event) {
    ...
    switch (event.keyCode) {
        ...
        case 90: alert(window.localStorage.length); break;
